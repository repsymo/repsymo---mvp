...
export interface CheckboxInputItem {
    ...
    /**
     * Key in which the checkbox value is found on the passed model, the bind
     * for the checkbox is then assigned with the next property
     * 'checkboxChildKey'. For example, the checkbox will be bound to
